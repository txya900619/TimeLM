...
class ThreeEmbLDCDataModule(LightningDataModule):
    def __init__(
        self,
    ...
    def setup(self, stage: str) -> None:
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            self.data_train = ThreeEmbLDCDataset(
                self.train_json_list_file_path, self.bos, self.eos
            )
            self.data_val = ThreeEmbLDCDataset(self.valid_json_list_file_path, self.bos, self.eos)
            self.data_test = ThreeEmbLDCDataset(self.test_json_list_file_path, self.bos, self.eos)
